    ...
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
          {renderCheckbox("dist", "Distance")}
          {renderCheckbox("elePos", "Dénivelé +")}
          {renderCheckbox("eleNeg", "Dénivelé -")}
          {renderCheckbox("timeInter", "Temps Inter.")}
          {renderCheckbox("timeTotal", "Temps Total")}
          {renderCheckbox("etaFast", "ETA Rapide")}
          {renderCheckbox("etaSlow", "ETA Lent")}
          {renderCheckbox("cutoff", "Barrière Hor.")}
          {renderCheckbox("pace", "Allure/Vitesse")}
          {renderCheckbox("nutrition", "Besoins Nutri.")}
          {renderCheckbox("vam", "VAM (avancé)")}
        </div>
      </div>
    </div>
  );
